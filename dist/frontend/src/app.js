...
class PokerPlanningApp {
    ...
    checkAuthAndSession() {
        ...
        this.username = (0, auth_1.getUsername)();
    ...
    connectWebSocket() {
        ...
        this.ws = new WebSocket(`ws://localhost:3000/websocket?token=${(0, auth_1.getAuthToken)()}&sessionId=${this.sessionId}`);
        this.ws.onopen = () => {
    ...
    handleLogout() {
        (0, auth_1.removeAuthToken)();
        (0, auth_1.removeUsername)();
