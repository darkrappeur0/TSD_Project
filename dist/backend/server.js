...
// Serve specific directories if needed (optional, for more explicit control)
...
app.get('/', (req, res) => {
    const mainHtmlPath = path_1.default.join(__dirname, '../../main.html');
    console.log('Serving main.html from:', mainHtmlPath);
...
app.get('/debug/files', (req, res) => {
    ...
    try {
        ...
        res.json({
            ...
            distExists: fs.existsSync(path_1.default.join(projectRoot, 'dist')),
            frontendExists: fs.existsSync(path_1.default.join(projectRoot, 'frontend')),
            mainHtmlExists: fs.existsSync(path_1.default.join(projectRoot, 'main.html'))
        });
    }
    catch (error) {
...
app.get('*', (req, res) => {
    ...
    res.sendFile(path_1.default.join(__dirname, '../../main.html'), (err) => {
        if (err) {
...
server.listen(PORT, () => {
    ...
    console.log(`📁 Project root: ${path_1.default.join(__dirname, '../..')}`);
